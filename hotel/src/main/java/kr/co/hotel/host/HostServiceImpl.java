...
//			Host_no 확인필요
			...
			System.out.println("확인확인"+reserve_count);
			System.out.println("확인확인"+today_sale);
			System.out.println("확인확인"+review_count);
			System.out.println("확인확인"+totalReview);
			System.out.println("확인확인"+avgScore);
